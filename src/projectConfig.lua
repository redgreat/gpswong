...
_G.mqtt_username = "aaa"
_G.mqtt_passwd = "bbb"
_G.mqtt_mqttHostUrl = "ccc"
_G.mqtt_port = 1883
...
_G.devicemodel = "restdeep_deviceupdate";
...
-- 深度休眠唤醒周期 1分钟
_G.deeprest_time = 1*60*1000

-- 消息传输模板
_G.REPORT_DATA_TEMPLATE = "{\"reporttime\":\"\"}"
...
-- LBS定位
_G.PRODUCT_KEY = "zqv3DfiOoIx0waquuK9LyuoHiflBXDpS"